...
const characters = [
  ...
  },
  {
    ...
    materials: ['Предвестник', 'Радуга роз', 'Транспаренсия'],
    talents: 'Автоатака → Элем. навык → Взрыв',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/7c589053-54ff-46f6-aa2a-21b4997120b2.jpg',
    teams: [
      { name: 'Испарение', members: ['Арлекино', 'Син Цю', 'Е Лань', 'Беннет'] },
      { name: 'Оверлоад', members: ['Арлекино', 'Фишль', 'Беннет', 'Чжун Ли'] },
      { name: 'Моно Пиро', members: ['Арлекино', 'Беннет', 'Сян Лин', 'Кадзуха'] }
    ]
  },
  {
    id: 14,
    ...
    materials: ['Цветок чистой воды', 'Старлайт', 'Гномы'],
    talents: 'Взрыв → Элем. навык → Автоатака',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/0f9b9a15-919a-46b1-9ffb-7652856404af.jpg',
    teams: [
      { name: 'Двойное Гидро', members: ['Е Лань', 'Ху Тао', 'Син Цю', 'Чжун Ли'] },
      { name: 'Национальная', members: ['Е Лань', 'Беннет', 'Сян Лин', 'Кадзуха'] },
      { name: 'Тазер', members: ['Е Лань', 'Фишль', 'Бэй Доу', 'Кукки Синобу'] }
    ]
  },
  {
    id: 15,
    ...
    materials: ['Вечный оазис', 'Лотос', 'Гномы'],
    talents: 'Элем. навык → Взрыв → Автоатака',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/f07c0a65-aeb7-4487-a4ff-e1cd605a7c29.jpg',
    teams: [
      { name: 'Блум', members: ['Нилу', 'Нахида', 'Кокоми', 'Кольей'] },
      { name: 'Двойное Дендро', members: ['Нилу', 'Нахида', 'Яо Яо', 'Кокоми'] },
      { name: 'Тройное Гидро', members: ['Нилу', 'Нахида', 'Син Цю', 'Кокоми'] }
    ]
  },
  {
    id: 16,
    ...
    materials: ['Марионетка', 'Падишахпура', 'Хандгарды'],
    talents: 'Автоатака → Элем. навык → Взрыв',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/bcddb8ea-9642-4d3d-bee8-6e5d7e094d67.jpg',
    teams: [
      { name: 'Моно Анемо', members: ['Странник', 'Фарузан', 'Беннет', 'Чжун Ли'] },
      { name: 'Агграва', members: ['Странник', 'Нахида', 'Фишль', 'Яо Яо'] },
      { name: 'Гипер', members: ['Странник', 'Фарузан', 'Беннет', 'Кадзуха'] }
    ]
  },
  {
    id: 17,
    ...
    materials: ['Мараджа', 'Нильпала лотос', 'Гномы'],
    talents: 'Автоатака → Взрыв → Элем. навык',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/fd382d60-03ad-4499-b5c7-5ee3f2c5c379.jpg',
    teams: [
      { name: 'Агграва', members: ['Тигнари', 'Фишль', 'Яо Яо', 'Кадзуха'] },
      { name: 'Спред', members: ['Тигнари', 'Нахида', 'Фишль', 'Кукки Синобу'] },
      { name: 'Квикен', members: ['Тигнари', 'Нахида', 'Яо Яо', 'Кадзуха'] }
    ]
  },
  {
    id: 18,
    ...
    materials: ['Скарабей', 'Кетчуп', 'Гномы'],
    talents: 'Элем. навык → Взрыв → Автоатака',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/996113b5-9ce4-4cbb-ab99-389ad7b365ba.jpg',
    teams: [
      { name: 'Агграва', members: ['Сайно', 'Нахида', 'Кадзуха', 'Чжун Ли'] },
      { name: 'Гипер Блум', members: ['Сайно', 'Нахида', 'Син Цю', 'Кукки Синобу'] },
      { name: 'Квикблум', members: ['Сайно', 'Нахида', 'Фурина', 'Барбелот'] }
    ]
  },
  {
    id: 19,
    ...
    materials: ['Опера', 'Радуга роз', 'Транспаренсия'],
    talents: 'Автоатака → Элем. навык → Взрыв',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/f2389296-36d6-4c51-b781-c5f59e777919.jpg',
    teams: [
      { name: 'Моно Пиро', members: ['Лини', 'Беннет', 'Кадзуха', 'Чжун Ли'] },
      { name: 'Оверлоад', members: ['Лини', 'Фишль', 'Беннет', 'Чжун Ли'] },
      { name: 'Мельт', members: ['Лини', 'Розария', 'Беннет', 'Кадзуха'] }
    ]
  },
  {
    id: 20,
    ...
    materials: ['Примофонтейн', 'Субдетекция', 'Транспаренсия'],
    talents: 'Автоатака → Элем. навык → Взрыв',
    image: 'https://cdn.poehali.dev/projects/a03e1018-a1b8-4dd0-ae61-a7d56755e339/files/4ae3d982-dda2-4812-9abf-2492223c9a30.jpg',
    teams: [
      { name: 'Фриз', members: ['Ризли', 'Фурина', 'Сёнхе', 'Кадзуха'] },
      { name: 'Мельт', members: ['Ризли', 'Беннет', 'Сян Лин', 'Кадзуха'] },
      { name: 'Моно Крио', members: ['Ризли', 'Сёнхе', 'Фурина', 'Кадзуха'] }
    ]
  }
];
